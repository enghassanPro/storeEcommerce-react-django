...
export const CreateProductBuilder = React.lazy(() => {
    return new Promise(resolve => {
        setTimeout(() => resolve(import('../Pages/products/Create/CreateProductBuilder')), 1 * 90)
    })
})

export const UpdateProductBuilder = React.lazy(() => {
    return new Promise(resolve => {
        setTimeout(() => resolve(import('../Pages/products/Update/UpdateProductBuilder')), 1 * 90)
    })
})